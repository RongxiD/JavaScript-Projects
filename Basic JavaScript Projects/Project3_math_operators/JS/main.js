function addition() {
  ...
  function Increment() {
    ...
    var value = parseInt(document.getElementById("IncrementText").innerHTML); // Saves the text of the HTML element to a variable
  ...
  function Decrement() {
    ...
    var value = parseInt(document.getElementById("DecrementText").innerHTML); // Saves the text of the HTML element to a variable
